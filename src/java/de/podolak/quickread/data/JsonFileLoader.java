...
public class JsonFileLoader {
    ...
    public static Document loadDocument(String filename) {
        return new Document(loadNode(filename));
    }
    ...
    public static Node loadNode(String filename) {
        ...
        try {
            //node = mapper.readValue(JsonLoader.class.getResourceAsStream("de/podolak/quickread/data/datastore/project1.json"), Node.class);
    ...
    private static void createDataStructure() {
        ...
        project.setId(1L);
        project.setSerializationVersion(DocumentPersistence.getDefaultVersion());
        ...
        Book book = new Book();
        book.setId(2L);
        book.setSerializationVersion(DocumentPersistence.getDefaultVersion());
        ...
        Song song = new Song();
        song.setId(5L);
        song.setSerializationVersion(DocumentPersistence.getDefaultVersion());
