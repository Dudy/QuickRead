 ...
 * @author Dude
 */
public class Document___bak1 implements Serializable {
    ...
    public Document___bak1() {
    }
    
    public Document___bak1(Document___bak1 other) {
    ...
    public Document___bak1(DocumentType documentType) {
        this(null, DocumentPersistence.getDefaultVersion(), getDefaultRootNode(documentType), new Date(), new Date(), documentType);
    }
    
    public Document___bak1(Node root, Date createDate, Date lastModifyDate, DocumentType documentType) {
        this(null, DocumentPersistence.getDefaultVersion(), root, createDate, lastModifyDate, documentType);
    }
    
    public Document___bak1(Integer serializationVersion, Node root, Date createDate, Date lastModifyDate, DocumentType documentType) {
        this(null, serializationVersion, root, createDate, lastModifyDate, documentType);
    }

    public Document___bak1(Long id, Integer serializationVersion, Node root, Date createDate, Date lastModifyDate, DocumentType documentType) {
        init(id, serializationVersion, root, createDate, lastModifyDate, documentType);
    }
    
    public final void init(Document___bak1 document) {
...
//    }
    ...
    public boolean equals(Object obj) {
        ...
        final Document___bak1 other = (Document___bak1) obj;
