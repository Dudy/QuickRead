...
public class DocumentHandler_v1 {
    ...
    public static Document deserialize(String content) {
        try {
            ...
            Logger.getLogger(DocumentHandler_v1.class.getName()).log(Level.SEVERE, "Fehler: kann keinen Parser erzeugen", e);
        } catch (org.xml.sax.SAXException e) {
            Logger.getLogger(DocumentHandler_v1.class.getName()).log(Level.SEVERE, "Fehler: kann das document nicht parsen", e);
        } catch (java.io.IOException e) {
            Logger.getLogger(DocumentHandler_v1.class.getName()).log(Level.SEVERE, "Fehler: kann das document nicht öffnen", e);
        }
